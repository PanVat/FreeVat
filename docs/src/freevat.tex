...
\newcommand\datumOdevzdani{31. 12. 2026} %% vyplň rok
\newcommand\nazevPrace{FreeVat} %% vyplň název své práce
\newcommand\popisProjektu{Webová aplikace pro správu 3D modelů} %% vyplň název své práce
\newcommand\jmenoAutora{Filip Podeszwa} %% vyplň název své práce
...
\begin{document}
	...
	{\fontfamily{phv}\selectfont
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.6\linewidth]{../img/school_logo.png} 
		\end{figure}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.8\linewidth]{../img/web_logo.png} 
		\end{figure}
	...
	\noindent Rád bych poděkoval panu Ing. Petru Grussmannovi za pomoc při nasazování aplikace na Kubernetes
	...
	\begin{figure}[h!]
		...
		\includegraphics[width=0.6\textwidth]{../img/school_logo.png} %% vložení samotného obrátku
	...
	\begin{figure}[h!] \centering
		\begin{subfigure}[h]{0.63\textwidth} %%prostředí pro podobrázek {šířka podobrázku}
			\includegraphics[width=\textwidth]{../img/vysledek_10} 
			\caption{} %% aby se ti vysázelo označení obrázku.
		\end{subfigure}
		\begin{subfigure}[h]{0.63\textwidth}
			\includegraphics[width=\textwidth]{../img/vysledek_20}
			\caption{}
		\end{subfigure}
